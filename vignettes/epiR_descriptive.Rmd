...
```
If you have a large number of regions the horizontal axis labels can become crowded and difficult to read. Use the `ndelete` function to drop every `n` region name.
...
```
Re-draw our ranked error bar plot:
