...
tmp.gg <- ggplot(data = gdat.df04, aes(x = log2(or.est), y = ybrk)) +
  theme_bw() +
  geom_point() + 
...
```{r mantel_haenszel, echo = FALSE, message = FALSE, fig.align = "center", out.width = "80%"}
...
tmp.gg <- ggplot(data = gdat.df06, aes(x = log2(or.est), y = ybrk)) +
  theme_bw() +
  geom_point() + 
